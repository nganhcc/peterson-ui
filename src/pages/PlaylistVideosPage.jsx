...
function PlaylistStudioSidebar({ onNavigate }) {
  return (
...
export default function PlaylistVideosPage({ onNavigate }) {
  ...
  return (
    <div className="min-h-screen bg-[#1f1f1f] text-[#f4f4f4]">
      ...
      <div className="grid min-h-screen grid-cols-[310px_minmax(0,1fr)] pt-[82px] max-lg:grid-cols-1">
        <PlaylistStudioSidebar onNavigate={onNavigate} />
                ...
                {videos.map((video) => (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-4 max-sm:flex-col max-sm:items-start">
                      <div className="relative aspect-video w-[128px] shrink-0 overflow-hidden rounded-[14px] border border-[#3c3c3c] max-sm:w-full">
